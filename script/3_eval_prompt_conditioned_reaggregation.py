"""Evaluate the trained prompt-conditioned re-aggregation model on validation and test splits."""
...
DEFAULT_REAGGREGATION_EVAL_BATCH_SIZE = 8


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate the trained prompt-conditioned residual-stream re-aggregation model."
    )
    ...
    parser.add_argument(
        ...
        help="Path to the saved prompt-conditioned re-aggregation checkpoint.",
    )
    parser.add_argument(
        "--model-dir",
        default=None,
    ...
    parser.add_argument(
        ...
        default=str(
            ...
            / "result"
            / "metrics"
            / "prompt_conditioned_residual_stream_reaggregation.json"
        ),
...
def main() -> None:
    ...
    model, checkpoint = load_prompt_conditioned_reaggregation_model_for_eval(
    ...
    metrics["model_type"] = "prompt_conditioned_residual_stream_reaggregation"
