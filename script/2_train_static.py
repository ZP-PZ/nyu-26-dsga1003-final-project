"""Train the static residual-scaling baseline."""
...
from _residual_modules import StaticResidualModel
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train the static residual-weighting baseline."
    )
    ...
    parser.add_argument(
        "--output-dir",
        default=str(repo_root / "artifact" / "checkpoints" / "static_residual"),
        help="Directory to save the trained static residual model and training history.",
    )
    parser.add_argument(
        "--batch-size",
        type=int,
